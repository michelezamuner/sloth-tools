...
describe('typer', () => {
  ...
  it('type eval exp of cons and cons', () => {
    const code = 'T = C T; a = T::C T::C;';
    const ast = Frontend.parse(code);
    const index = Indexer.index(ast);
  ...
  it('type eval exp of ref and cons', () => {
    const code = 'T = C; a = ! T::C;';
    const ast = Frontend.parse(code);
    const index = Indexer.index(ast);
  ...
  it('type eval exp of fun and ref', () => {
    const code = 'T = C; f = a: T -> T f;';
    const ast = Frontend.parse(code);
    const index = Indexer.index(ast);
